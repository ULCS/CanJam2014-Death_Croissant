			...
			foreach (tk2dSpriteCollectionDefinition.ColliderData rawCollider in src.colliderData) {
				...
				switch (rawCollider.type) {
					case tk2dSpriteCollectionDefinition.ColliderData.Type.Box: {
						tk2dSpriteColliderDefinition gameColliderDef = new tk2dSpriteColliderDefinition( tk2dSpriteColliderDefinition.Type.Box, colliderOrigin, rawCollider.angle );
					...
					case tk2dSpriteCollectionDefinition.ColliderData.Type.Circle: {
						...
						tk2dSpriteColliderDefinition gameColliderDef = new tk2dSpriteColliderDefinition( tk2dSpriteColliderDefinition.Type.Circle, colliderOrigin, rawCollider.angle );
